...
ROOT = r"C:\github-vba-lab\github-vba-lab"
HTML_PATH = os.path.join(ROOT, "工場見学.html")
OUTPUT_DIR = os.path.join(ROOT, "presentations", "FactoryTour")
OUTPUT_PATH = os.path.join(OUTPUT_DIR, "FactoryTour_Presentation.pptx")
...
# Key insights at bottom of left column if space
key_height = add_key_insights(slide, left_x, prs.slide_height - Inches(1.7), left_width)
