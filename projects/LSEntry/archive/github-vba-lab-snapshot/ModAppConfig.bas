...
' 列追加ポリシーの既定値
Public Const DEFAULT_COLUMN_ADD_POLICY As Long = AddPolicy_Prompt

' ドライランモードの既定値（True の場合は書き込みを行わない）
Public Const DEFAULT_DRY_RUN_MODE As Boolean = False
